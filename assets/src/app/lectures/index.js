 ...
 */
angular.module( 'sailng.lectures', [
])
.config( ['$stateProvider',function config( $stateProvider ) {
    $stateProvider.state( 'lectures', {
        url: '/lectures',
        views: {
            "main": {
                controller: 'UserCtrl',
                templateUrl: 'lectures/index.tpl.html'
            }
        },
        data:{ pageTitle: 'User' }
    });
}])
.controller( 'UserCtrl',['$scope', '$sails', 'lodash', 'config', 'titleService', 'LectureModel','$filter', 'ngTableParams', function LectureController( $scope, $sails, lodash, config, titleService, UserModel,$filter, ngTableParams ) {
